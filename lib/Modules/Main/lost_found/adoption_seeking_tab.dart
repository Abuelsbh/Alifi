...
class AdoptionSeekingTab extends StatefulWidget {
  const AdoptionSeekingTab({super.key});

  @override
  State<AdoptionSeekingTab> createState() => _AdoptionSeekingTabState();
}

class _AdoptionSeekingTabState extends State<AdoptionSeekingTab> {
    ...
    try {
      ...
      final activeDocs = querySnapshot.docs.where((doc) {
        try {
          ...
          // Filter by adoptionType = 'seeking'
          if (data['adoptionType'] != 'seeking') return false;
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TranslatedText(
            'adoption.no_seeking_pets_subtitle',
